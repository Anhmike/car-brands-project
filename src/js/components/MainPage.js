        ...
        return (
                <div className="clearfix">
                    <Panel>
                        ...
                        <p>
                            Cars are equipped with controls used for driving, parking, passenger comfort and safety and controlling a variety of lights. As of the 2010s, controls have been added to vehicles, making them more complex. Examples include rear reversing cameras, air conditioning, navigation systems, and in car entertainment. Most cars in use in the 2010s are propelled by an internal combustion engine, fueled by deflagration of gasoline (also known as petrol) or diesel. Both fuels cause air pollution and are also blamed for contributing to climate change and global warming. Vehicles using alternative fuels such as ethanol flexible-fuel vehicles and natural gas vehicles are also gaining popularity in some countries. Electric cars, which were invented early in the history of the automobile, began to become commercially available in 2008.
                        </p>
                        <p>
